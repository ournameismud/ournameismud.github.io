...
const assets = './_assets/'
	 ...
	 */
const publicHtml = 'docs'
const build = (state === 'dev') ? `${publicHtml}/dist/` : `deploy/${publicHtml}/dist/`
const root = (state === 'dev') ? `${publicHtml}/` : `deploy/${publicHtml}/`
	// where should the pug templates be built, usually root, except when state === cms
const url = 'magicspon.github.io'
